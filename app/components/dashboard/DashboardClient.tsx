    ...
    <div className="min-h-screen bg-[#0d1117] text-white">
      ...
      <nav className="border-b border-[#30363d] bg-[#161b22] px-6 py-4 flex items-center justify-between sticky top-0 z-50">
        <div className="flex items-center gap-2">
          <img src="/icon.png" alt="GitPulse" className="w-7 h-7 rounded-sm" />
          <span className="font-semibold text-lg">GitPulse</span>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-6 p-6 rounded-2xl border border-[#30363d] bg-[#161b22]">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              rel="noopener noreferrer"
              className="px-4 py-2
            rounded-lg border border-[#30363d] text-sm hover:border-[#238636]
            hover:text-[#3fb950] transition-colors"
            >
              View on GitHub →
            </a>
          </div>
